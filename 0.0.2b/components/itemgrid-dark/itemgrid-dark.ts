...
@Component({
    ...
    <ng-container *ngIf="this.getFilteredSourceItems() && this.getFilteredSourceItems().length != 0">
        <span *ngIf="this.sourceTitle" class="itemgrid-dark-title">{{this.sourceTitle}}</span>
    ...
    <ng-container *ngFor="let extends of this.extensionsData; let i = index;">
        <ng-container *ngIf="this.getFilteredExtensionItems(i) && this.getFilteredExtensionItems(i).length != 0">
            <span *ngIf="this.extensionTitles[i]" class="itemgrid-dark-title">{{this.extensionTitles[i]}}</span>
            <ul class="itemgrid-dark-grid">
...
export class ItemGridDarkComponent implements OnInit
{
    /* ATTRIBUTES */
